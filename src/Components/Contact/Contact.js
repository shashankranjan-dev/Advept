  ...
  return (
    <>
      <div className="bg-black">
        {" "}
        <div class="container max-w-screen-xl px-5 py-28 mx-auto">
          <div class="flex flex-wrap w-full ">
            <div class="lg:w-1/2 w-full mb-6 lg:mb-0">
              <h1 class="sm:text-4xl text-2xl font-medium title-font mb-2 text-gray-200">
                Let's Visit us at Office
              </h1>
              <div class="h-1 w-20 bg-indigo-500 rounded"></div>
            </div>
            <p class="lg:w-1/2 w-full  leading-relaxed text-gray-200">

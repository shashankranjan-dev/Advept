...
function Contact() {
  return (
    <div class="bg-black">
      <section class="text-white body-font relative pt-24">
        <div class="max-w-2xl lg:max-w-4xl mx-auto text-center">
          <h2 class="text-4xl font-medium text-gray-100">Submit Your Query</h2>
        ...
        <div class="container px-5 py-24 mx-auto flex sm:flex-nowrap flex-wrap">
          ...
          <div class="lg:w-1/3 md:w-1/2 bg-black flex flex-col  w-full md:py-8 mt-8 md:mt-0">

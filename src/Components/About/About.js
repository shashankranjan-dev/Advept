...
import Cretification from "./Cretification";
  ...
  return (
    <div>
      ...
      <div className="2xl:container 2xl:mx-auto lg:py-16 lg:px-5 md:py-12 md:px-6 py-9 px-4">
        ...
        <div className="flex lg:flex-row flex-col lg:gap-8 sm:gap-10 gap-12">
          <div className="w-full lg:w-6/12">
            ...
            <p className="font-normal text-base leading-6 text-gray-600 mt-6 text-justify">
              ...
              have her rights entire. It is a long established fact that a
              reader will be distracted by the readable content of a page when
              looking at its layout. The point of using Lorem Ipsum.In the first
              ...
              shall be free, and shall have her rights entire,
              <br /> <br />
              It is a long established fact that a reader will be distracted by
              the readable content of a page when looking at its layout. The
              point of using Lorem Ipsum.In the first place we have granted to
          ...
          <div className="w-full lg:w-6/12">
            <Lottie
              ...
              className="h-[500px] bg-none lg:block hidden w-full"
            />
            <Lottie
              animationData={animation}
              className="h-[500px] bg-none lg:hidden sm:block hidden w-full"
            />
            <Lottie
              animationData={animation}
              className="h-[500px] bg-none sm:hidden block w-full"
            />
          </div>
        </div>
        ...
        <div className="grid sm:grid-cols-3 grid-cols-2 sm:gap-16 gap-10">
          <div>
        ...
        <div className="flex lg:flex-row flex-col md:gap-14 gap-16 justify-between lg:mt-20 mt-16">
          <div className="w-full lg:w-6/12">
            ...
            <p className="font-normal text-base leading-6 text-gray-600 mt-6 w-full lg:w-10/12 xl:w-9/12 text-justify">
              It is a long established fact that a reader will be distracted by
              the readable content of a page when looking at its layout. The
              point of using Lorem Ipsum.In the first place we have granted to
              God, and by this our present charter confirmed for us and our
            ...
            <p className="font-normal text-base leading-6 text-gray-600 w-full lg:w-10/12 xl:w-9/12 mt-10 text-justify">
              It is a long established fact that a reader will be distracted by
              the readable content of a page when looking at its layout. The
              point of using Lorem Ipsum.In the first place we have granted to
              God, and by this our present charter confirmed for us and our
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 lg:gap-12 gap-10">
              ...
              <div className="flex p-4 shadow-md">
                ...
                <div className="">
                  ...
                  <p className="mt-2 font-normal text-base leading-6 text-gray-600 text-justify">
